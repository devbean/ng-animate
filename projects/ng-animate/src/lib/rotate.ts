...
export function rotateInDirection(origin: string | number, degrees: string | number) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
...
export function rotateOutDirection(origin: string | number, degrees: string | number) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s',
      keyframes([
