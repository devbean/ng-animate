...
export function zoomInY(a: string | number, b: string | number) {
  return animation(
    animate(
...
export function zoomInX(a: string | number, b: string | number) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s cubic-bezier(0.550, 0.055, 0.675, 0.190)',
      keyframes([
...
export function zoomOutY(a: string | number, b: string | number) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s cubic-bezier(0.550, 0.055, 0.675, 0.190)',
      keyframes([
...
export function zoomOutX(a: string | number, b: string | number) {
  return animation(
    animate(
      '{{ timing }}s {{ delay }}s cubic-bezier(0.550, 0.055, 0.675, 0.190)',
      keyframes([
